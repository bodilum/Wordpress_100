            ...
            <div class="col-md-12">
              <div class="breadcrumbs-inner bread-<?php echo esc_attr($post_menu_type); ?>"> 
                <?php 
                    ...
                    ?>
                    <h1 class="page-title">
                        <?php if(!empty($swipy_option['team_sigle_txt'])){
                            echo esc_html($swipy_option['team_sigle_txt']);
                         } else {
                            if($content_banner !=''){
                               echo esc_html($content_banner);
                            } else {
                               esc_html_e('Team Single', 'swipy');
                            }
                        } ?>
                    </h1>

                    <?php } 
                     if(!empty($swipy_option['team_sigle_txt_desc'])){ ?>
                    <p> <?php echo wp_kses_post($swipy_option['team_sigle_txt_desc']);?></p>
                <?php }
...
elseif (!empty($swipy_option['team_single_image']['url'])) {?>
<div class="breadcrumbs-single" style="background-image: url('<?php echo esc_url( $swipy_option['team_single_image']['url'] );?>')">
    <div class="<?php echo esc_attr($header_width);?>">
      <div class="row">
        <?php if( !empty( $swipy_option['footer_icon_animation']['url'])){?>
            <div class="footer-animision-icon">
