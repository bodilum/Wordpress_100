...
<!-- Mobile Menu Start -->
    <div class="responsive-menus">
        ...
        <?php require get_parent_theme_file_path('inc/header/responsive-menu.php');?></div>
<!-- Mobile Menu End -->
...
<header id="rs-header" class="single-header header-style1 mainsmenu<?php echo esc_attr($main_menu_hides);?> <?php echo esc_attr($main_menu_center);?> <?php echo esc_attr($main_menu_icon);?>">
    ...
    <div class="header-inner <?php echo esc_attr($sticky_menu);?>">
        ...
        ?>
        <div class="menu-area menu_type_<?php echo esc_attr($main_menu_type);?>" <?php echo wp_kses($menu_bg_color, 'swipy');?>>
                ...
                <div class="row-table">
                    ...
                    <div class="col-cell header-quote">     
                        ...
                        if($rs_show_cart != 'hide'){
                            if(!empty($swipy_option['wc_cart_icon'])) { ?>
