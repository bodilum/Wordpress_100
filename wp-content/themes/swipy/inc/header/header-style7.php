            ...
            <div class="<?php echo esc_attr($header_width);?>">
                ...
                <div class="row-table">
                    ...
                    <div class="col-cell menu-responsive">  
                        ...
                        <?php } elseif (!empty( $swipy_option['logo']['url'] ) ) { ?>
                          <a href="<?php echo esc_url( home_url( '/' ) ); ?>" rel="home" class="mobile-logos"><img <?php echo wp_kses($logo_height, 'swipy');?> src="<?php echo esc_url( $swipy_option['logo']['url']); ?>" alt="<?php echo esc_attr( get_bloginfo( 'name' ) ); ?>"></a>
                        <?php }
                         else{?>
