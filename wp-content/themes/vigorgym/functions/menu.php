...
register_nav_menus(
	array(
		'main-nav'		=> __( 'The Main Menu', 'vcgc_v1' ),		// Main nav in header
		'offcanvas-nav'	=> __( 'The Off-Canvas Menu', 'vcgc_v1' ),	// Off-Canvas nav
		'footer-links'	=> __( 'Footer Links', 'vcgc_v1' )			// Secondary nav in footer
	)
);
