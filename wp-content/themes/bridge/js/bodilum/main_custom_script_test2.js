...
const animGenPgContentsIn = () => {
  ...
  var timeOut1 = setTimeout(() => {
    ...
    tl1.fromTo("#mainHeader ._mainLogo1", { x: -200, opacity: 0, display: 'none' }, 
...
const animPgContentsIn = () => {
  ...
  switch(pg_slug) {
    ...
    stagger: { amount: 1 } })
      ...
      .fromTo('#aboutPgSects2 ._body1 ._itm', 
...
const animGenPgContentsOut = () => {
  ...
  var timeOut1 = setTimeout(() => {   
    ...
    tl1.fromTo("#mainHeader ._mainLogo1", { x: 0, opacity: 1, display: 'block' }, 
    { duration: 1.4, x: -100, ease: "power4.out", opacity: 0, display: 'none' })
    .fromTo("#mainHeader ._mainNavs ._itm1", { y: 0, opacity: 1, display: 'block' }, 
...
$(document).on('click', '#mainMediaNav ._mainContents.' + pgNavMainClass + ' ._itmCard._mini', function() {
...
const initHomeMainNavScripts = () => {
  ...
  if (window.addEventListener)
  {
      ...
      $("#mainMediaNav ._mainContents." + pgNavMainClass + " ._itmCard").mouseenter(function() {
      ...
      $("#mainMediaNav ._mainContents." + pgNavMainClass + " ._itmCard").mouseout(function() {        
...
const makeNavWave2 = () => {
  ...
  if(navRisingIndArr.length > 0) {   
    ...
    navRisingIndArr.forEach((v, i) => {
      ...
      let activNavItm = $(`#mainMediaNav ._mainContents.${ pgNavMainClass } ._itmCard:nth-of-type(${v+1}) ._itm`);
