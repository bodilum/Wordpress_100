	...
	protected function register_controls() {
        ...
        $this->add_control(
            ...
            [
                ...
                'selectors' => [
                    '{{WRAPPER}} select:valid, {{WRAPPER}} .wpcf7-form-control:not(.wpcf7-submit)' => 'color: {{VALUE}}',
                ],
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'type' => Controls_Manager::COLOR,
                'selectors' => [
                    '{{WRAPPER}} .request-a-services select, {{WRAPPER}} .wpcf7-form-control:not(.wpcf7-submit)' => 'background-color: {{VALUE}}',
                ],
            ]
		);
        ...
        $this->add_responsive_control(
         ...
         $this->add_control(
            ...
            [
                ...
                'type' => Controls_Manager::COLOR,            
                'selectors' => [
                    '{{WRAPPER}} .home-two-contact .form-button svg, {{WRAPPER}} .chatbot-submit-btn:before' => 'color: {{VALUE}};',
                ],
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'type' => Controls_Manager::COLOR,
                'selectors' => [
                    '{{WRAPPER}} .home-two-contact .form-button svg, {{WRAPPER}} .wpcf7-submit:hover, {{WRAPPER}} .wpcf7-submit:focus' => 'color: {{VALUE}};',
                ],
            ]
        );
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'toggle' => true,
                'selectors' => [
                    '{{WRAPPER}} .submit-btn .wpcf7-submit, {{WRAPPER}} .form-button' => 'text-align: {{VALUE}}'
                ]
            ]
        );
