...
class Rsaddon_Elementor_Pro_Blog_Slider_Widget extends \Elementor\Widget_Base {
    ...
    protected function register_controls() {       
        ...
        $this->add_control(
            ...
            [
                ...
                'options' => [
                    ...
                    'blog_style_4' => esc_html__( 'Blog Style Four', 'rsaddon' ),
        ...
        $this->add_control(
            'meta_postion_style',
            [
                'label' => esc_html__( 'Meta Position', 'rsaddon' ),
                'type' => Controls_Manager::SELECT,
                'default' => 'top',
                'options' => [
                    'bottom' => esc_html__( 'Bottom', 'rsaddon' ),
        ...
        $this->add_control(
            ...
            [
                ...
                'separator' => 'before',
                'condition' => [
                    'blog_content_postion_style' => 'default',
                ]
            ]
        );

        $this->add_control(
            'blog_separator_show_hide',
            [
        ...
        $this->add_control(
            'blog_meta_icon_hide',
            [
                'label' => esc_html__( 'Meta Icon Show/Hide', 'rsaddon' ),
                'type' => Controls_Manager::SELECT,
                'default' => 'yes',
                'options' => [
                    'yes' => esc_html__( 'Yes', 'rsaddon' ),
        ...
        $this->add_control(
            'blog_title_show_position',
            [
                'label' => esc_html__( 'Blog Title Show Above Meta', 'rsaddon' ),
                'type' => Controls_Manager::SELECT,
                'default' => 'no',
                'options' => [
                    'title-yes' => esc_html__( 'Yes', 'rsaddon' ),
                    'no' => esc_html__( 'No', 'rsaddon' ),
                ],                
                'separator' => 'before',
            ]
        ...
        $this->add_control(
            'blog_readmore_show_hover',
            [
                'label' => esc_html__( 'Read More Show Item Hover', 'rsaddon' ),
                'type' => Controls_Manager::SELECT,
                'default' => 'no',
                'options' => [
                    'yes' => esc_html__( 'Yes', 'rsaddon' ),
        ...
        $this->add_control(
            'blog_btn_border',
            [
                'label' => esc_html__( 'Button Border Yes/No', 'rsaddon' ),
                'type' => Controls_Manager::SELECT,
                'default' => 'btn_borer_no',
                'options' => [
                    'default' => esc_html__( 'Default', 'rsaddon' ),
                    'btn_borer_yes' => esc_html__( 'Yes', 'rsaddon' ),
                    'btn_borer_no' => esc_html__( 'No', 'rsaddon' ),
                ],                
                'condition' => [
                    'blog_readmore_show_hide' => 'yes',
                ]
        ...
        $this->add_control(
            'dots_bg',
            [
                'label' => esc_html__( 'Dots Bg Color', 'rsaddon' ),
                'type' => Controls_Manager::COLOR,
                'selectors' => [
                    '{{WRAPPER}} .rs-addon-slider .slick-dots li button, 
                    {{WRAPPER}} .rs-testimonial-dots-style2 .slick-dots li button' => 'background-color: {{VALUE}};',
                ],
                'condition' => [
                    'slider_dots' => 'true',
                ],
        ...
        $this->add_control(
            'dots_bg_active',
            [
                'label' => esc_html__( 'Dots Bg Active Color', 'rsaddon' ),
                'type' => Controls_Manager::COLOR,
                'selectors' => [
                    '{{WRAPPER}} .rs-addon-slider .slick-dots li.slick-active button, 
                    {{WRAPPER}} .rs-testimonial-dots-style2 .slick-dots li.slick-active button' => 'background-color: {{VALUE}};',
                ],
                'condition' => [
                    'slider_dots' => 'true',
                ],
        ...
        $this->add_control(
            ...
            [
                ...
                'size_units' => [ 'px', '%' ],
                'selectors' => [
                    '{{WRAPPER}} .rs-testimonial-dots-style2 .slick-dots li button, {{WRAPPER}} .rs-addon-slider .slick-dots li button' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                ],
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'type' => Controls_Manager::COLOR,
                'selectors' => [
                    '{{WRAPPER}} .btm-rs .blog-footer .blog-meta li, {{WRAPPER}} .btm-rs .blog-footer .blog-meta .cat_list.btm ul li a' => 'color: {{VALUE}};',
                ],                
            ]
        );

        $this->add_control(
            'meta_hover_date_color',
            [
                'label' => esc_html__( 'Meta Hover Color', 'rsaddon' ),
                'type' => Controls_Manager::COLOR,
                'selectors' => [
                    '{{WRAPPER}} .transparent .blog-inner-wrap:hover .blog-meta .cat_list.btm ul li a, {{WRAPPER}} .transparent .blog-inner-wrap:hover .blog-meta li, {{WRAPPER}} .btm-rs .blog-footer .blog-meta .cat_list.btm ul li a:hover' => 'color: {{VALUE}};',
                    '{{WRAPPER}} .blog-style4:hover .blog-footer .blog-meta li' => 'color: {{VALUE}};',
                    '{{WRAPPER}} .blog-style4:hover .blog-footer .blog-meta .cat_list.btm ul li a' => 'color: {{VALUE}};',
                ],                
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'type' => Controls_Manager::COLOR,
                'selectors' => [
                    '{{WRAPPER}} .rsaddon-unique-slider .blog-content .blog-footer .blog-meta i' => 'color: {{VALUE}};',
                ], 
                'condition' => [
                    'blog_meta_icon_hide' => 'yes',
                ]               
            ]
        );
        ...
        $this->add_control(
            ...
            [
                'label' => esc_html__( 'Meta Separator Color', 'rsaddon' ),
                'type' => Controls_Manager::COLOR,
                'selectors' => [
                    '{{WRAPPER}} .btm-rs .blog-footer .blog-meta.sep-yes li:after' => 'background: {{VALUE}};',

                ], 
                'condition' => [
                    'blog_separator_show_hide' => 'yes',
                ]               
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'selectors' => [
                    ...
                    '{{WRAPPER}} .rs-blog-grid .blog-item.blog_style_2.slick-slide .blog-meta:after' => 'border-bottom-color: {{VALUE}};',
                ],
                'condition' => [
        ...
        $this->add_group_control(
            ...
            [
                ...
                'label' => esc_html__( 'Category Text Typography', 'rsaddon' ),
                'selector' => 
                    '{{WRAPPER}} .btm-rs .blog-footer .blog-meta .cat_list.btm ul li a, {{WRAPPER}} .btm-rs .blog-footer .blog-meta li',
            ]
        );
        ...
        $this->add_group_control(
            ...
            [
                ...
                'label' => esc_html__( 'Date Text Typography', 'rsaddon' ),
                'selector' => 
                    '{{WRAPPER}} .rs-blog-grid .blog-item.transparent .blog-inner-wrap .blog-content .blog-meta .blog_day',
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'type' => Controls_Manager::COLOR,
                'selectors' => [
                    '{{WRAPPER}} .rsaddon-unique-slider .image-wrap .date' => 'color: {{VALUE}};',
                ],    
                'condition' => [
                    'blog_content_postion_style' => 'default',
                ],              
        ...
        $this->add_control(
            ...
            [
                ...
                'type' => Controls_Manager::COLOR,
                'selectors' => [
                    '{{WRAPPER}} .rsaddon-unique-slider .image-wrap .date' => 'background: {{VALUE}};',
                ],    
                'blog_content_postion_style' => 'default',            
            ]
        );
        ...
        $this->add_control(
            'date_bg_colordd',
            [
                'label' => esc_html__( 'Meta border Color', 'rsaddon' ),
                'type' => Controls_Manager::COLOR,
                'selectors' => [
                    '{{WRAPPER}} .rs-blog-grid .blog-item .blog-content .blog-meta' => 'border-color: {{VALUE}};',
                ],    
                'blog_content_postion_style' => 'default',            
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'type' => Controls_Manager::COLOR,
                'selectors' => [
                    '{{WRAPPER}} .transparent .blog-inner-wrap:hover .blog-content h3.blog-name a, {{WRAPPER}} .blog-item .blog-content h3.blog-name a:hover' => 'color: {{VALUE}};',
                    '.rs-blog-grid .blog-content.blog-style4 h3.blog-name a:hover' => 'color: {{VALUE}};',
                ],                
            ]
        );
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'selectors' => [
                    '{{WRAPPER}} .blog-content h3.blog-name' => 'margin: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                ],
            ]
        );
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'selectors' => [
                    '{{WRAPPER}} .blog-content h3.blog-name' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                ],
            ]
        );
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'selectors' => [
                    '{{WRAPPER}} .rs-blog-grid .blog-item.default .blog-content p, {{WRAPPER}} .rs-blog-grid .blog-item .blog-content p' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                ],
                'separator' => 'before',
            ]
        );
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'selectors' => [
                    '{{WRAPPER}} .rs-blog-grid .blog-item .image-wrap' => 'margin: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                ],
                'separator' => 'before',
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'size_units' => [ 'px', '%' ],
                'selectors' => [
                    '{{WRAPPER}} .rs-blog-grid .blog-item .image-wrap img' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                ],
                'separator' => 'before',
            ]
        );
        ...
        $this->add_control(
            'content_color_hover',
            [
                'label' => esc_html__( 'Content Hover Color', 'rsaddon' ),
                'type' => Controls_Manager::COLOR,
                'selectors' => [
                    '{{WRAPPER}} .transparent .blog-inner-wrap:hover .blog-content p' => 'color: {{VALUE}};',
                ],    
                'separator' => 'before',   
                'condition' => [
                    'blog_content_postion_style' => 'transparent',
                ],         
            ]
        );
        ...
        $this->add_responsive_control(
            'blog_area_content_margn',
            [
                'label' => esc_html__( 'Blog Area Margin', 'rsaddon' ),
                'type' => Controls_Manager::DIMENSIONS,
                'range' => [
                    'px' => [
                        'max' => 100,
                ...
                'selectors' => [
                    '{{WRAPPER}} div.rs-blog-grid .blog-item' => 'margin: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                ],
            ]
        );
        $this->add_responsive_control(
            ...
            [
                ...
                'type' => Controls_Manager::COLOR,
                'selectors' => [
                    '{{WRAPPER}} .rs-blog-grid .blog-item.transparent .blog-inner-wrap .image-wrap:before, {{WRAPPER}} .rs-blog-grid .blog-item .blog-inner-wrap' => 'background: {{VALUE}};',
                ],
            ]
        );
        ...
        $this->add_control(
            'blog_hoverbg_title',
            [
                'label' => esc_html__( 'Blog Hover Background', 'rsaddon' ),
         ...
         $this->add_group_control(
            ...
            [
                ...
                'selector' => '{{WRAPPER}} .rs-blog-grid .blog-item.transparent .blog-inner-wrap:hover .image-wrap::before',
        ...
        $this->add_control(
            'item_border_radius',
            [
                'label' => esc_html__( 'Item Border Radius', 'rsaddon' ),
                'type' => Controls_Manager::DIMENSIONS,
                'size_units' => [ 'px', '%' ],
                'selectors' => [
                    '{{WRAPPER}} .rs-blog-grid .blog-item' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                ],
                'separator' => 'before',
            ]
        );
        ...
        $this->add_responsive_control(
            'blog_area_content_hover_bg',
            [
                'label' => esc_html__( 'Blog Hover Background', 'rsaddon' ),
                'type' => Controls_Manager::COLOR,
                'selectors' => [
                    '{{WRAPPER}} .rs-blog-grid .blog-content.blog-style4:hover' => 'background: {{VALUE}};',
                ],
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'type' => Controls_Manager::COLOR,
                'selectors' => [
                    '{{WRAPPER}} .btm-rs .blog-footer .blog-meta .cat_list.btm ul li a, {{WRAPPER}} .rs-blog-grid .blog-item .image-wrap .cat_list ul li a' => 'color: {{VALUE}};',
                ],                  
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'type' => Controls_Manager::COLOR,
                'selectors' => [
                    '{{WRAPPER}} .btm-rs .blog-footer .blog-meta .cat_list.btm ul li a:hover, {{WRAPPER}} .rs-blog-grid .blog-item .image-wrap .cat_list ul li a:hover' => 'color: {{VALUE}};',
        ...
        $this->add_control(
           'cate_border_radius',
            [
               ...
               'size_units' => [ 'px', '%' ],
               'selectors' => [
                   '{{WRAPPER}} .rs-blog-grid .image-wrap .date, {{WRAPPER}} .rs-blog-grid .blog-item .image-wrap .cat_list ul li a' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                ],
            ]
        );
        ...
        $this->add_group_control(
            ...
            [
                'name' => 'cat_typography',
                'selector' => '{{WRAPPER}} .btm-rs .blog-footer .blog-meta .cat_list.btm ul li a, {{WRAPPER}} .rs-blog-grid .blog-item .image-wrap .cat_list ul li a',
            ]
        );
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'size_units' => [ 'px', 'em', '%' ],
                'selectors' => [
                    '{{WRAPPER}} .blog-item .blog-content .blog-btn, {{WRAPPER}} .blog-item .blog-content .custom-blog-btn, {{WRAPPER}} .rs-blog-grid .blog-item.blog_style_2.slick-slide .blog-content .blog-btn-part2 a' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                ],
            ]
        );
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'size_units' => [ 'px', 'em', '%' ],
                'selectors' => [
                    '{{WRAPPER}} .blog-item .blog-content .blog-btn-part, {{WRAPPER}} .rs-blog-grid .blog-item.blog_style_2.slick-slide .blog-content .blog-btn-part2' => 'margin: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                ],
            ]
        );
        ...
        $this->add_group_control(
            ...
            [
                'name' => 'btn_typography',
                'selector' => '{{WRAPPER}} .blog-item .blog-content .blog-btn, {{WRAPPER}} .rs-blog-grid .blog-item.blog_style_2.slick-slide .blog-content .blog-btn-part2 a',
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'selectors' => [
                    ...
                    '{{WRAPPER}} .rs-blog-grid .blog-item.blog_style_2.slick-slide .blog-content .blog-btn-part2 a .custom-blog-btn' => 'color: {{VALUE}};',
                ],
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'default' => '',
                'selectors' => [
                    '{{WRAPPER}} .rs-blog-grid .blog-item .blog-content .blog-btn-part .blog-btn.icon-after i' => 'border-color: {{VALUE}};',
                ],
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'type' => Controls_Manager::COLOR,            
                'selectors' => [
                    '{{WRAPPER}} .rs-blog-grid .blog-item .blog-content .blog-btn-part .blog-btn:after' => 'background: {{VALUE}};',
                ],
                'separator' => 'before',
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'type' => Controls_Manager::COLOR,
                'selectors' => [
                    '{{WRAPPER}} .blog-item .blog-content .blog-btn, {{WRAPPER}} .rs-blog-grid .blog-item.blog_style_2.slick-slide .blog-content .blog-btn-part2 a' => 'background-color: {{VALUE}};',
                ],
            ]
        );
        ...
        $this->add_group_control(
            ...
            [
                ...
                'selector' => '{{WRAPPER}} .blog-item .blog-content .blog-btn.icon-after i',
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'size_units' => [ 'px', '%' ],
                'selectors' => [
                    '{{WRAPPER}} .blog-item .blog-content .blog-btn.icon-after i, {{WRAPPER}} .rs-blog-grid .blog-item.blog_style_2.slick-slide .blog-content .blog-btn-part2 a' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                ],
            ]
        );
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'size_units' => [ 'px', 'em', '%' ],
                'selectors' => [
                    '{{WRAPPER}} .blog-item .blog-content .blog-btn.icon-after i' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                ],
            ]
        );
        ...
        $this->add_control(
            'btn_border_title',
            [
                'label' => __( 'Button Border Color', 'rsaddon' ),
                'type' => \Elementor\Controls_Manager::HEADING,
                'placeholder' => __( 'Enter your title', 'rsaddon' ),
            ]
        );
        ...
        $this->add_group_control(
            \Elementor\Group_Control_Background::get_type(),
            [
                'name' => 'btn_border_background',
                'label' => esc_html__( 'Button Border Color', 'rsaddon' ),
                'types' => [ 'classic', 'gradient', 'video' ],
                'selector' => '{{WRAPPER}} .rs-blog-grid .blog-item .blog-content .btn_borer_yes a:after',
                'condition' => [
                    'blog_readmore_show_hide' => 'yes',
                ]
        ...
        $this->add_control(
            ...
            [
                ...
                'type' => Controls_Manager::COLOR,
                'selectors' => [
                    '{{WRAPPER}} .transparent .blog-inner-wrap:hover .blog-btn, {{WRAPPER}} .rs-blog-grid .blog-item.blog_style_2.slick-slide:hover .blog-content .blog-btn-part2 a, {{WRAPPER}} .blog-item .blog-content .blog-btn:hover, {{WRAPPER}} .blog-item .blog-content .custom-blog-btn:hover, {{WRAPPER}} .blog-item .blog-content .blog-btn:hover, {{WRAPPER}} .rs-blog-grid .blog-item.blog_style_2.slick-slide:hover .blog-content .blog-btn-part2 a .custom-blog-btn' => 'color: {{VALUE}};',
                ],
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'type' => Controls_Manager::COLOR,
                'selectors' => [
                    '{{WRAPPER}} .blog-item .blog-content .blog-btn:hover, {{WRAPPER}} .rs-blog-grid .blog-item.blog_style_2.slick-slide .blog-content .blog-btn-part2 a:hover' => 'background-color: {{VALUE}};',
                ],
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'default' => '',
                'selectors' => [
                    '{{WRAPPER}} .rs-blog-grid .blog-item .blog-content .blog-btn-part .blog-btn.icon-after:hover i' => 'color: {{VALUE}};',
                ],
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'default' => '',
                'selectors' => [
                    '{{WRAPPER}} .rs-blog-grid .blog-item .blog-content .blog-btn-part .blog-btn.icon-after:hover i' => 'border-color: {{VALUE}};',
                ],
            ]
        );
        ...
        $this->add_group_control(
            Group_Control_Border::get_type(),
            [
                'name' => 'icon_button_border_hover',
                'selector' => '{{WRAPPER}} .blog-item .blog-content .blog-btn.icon-after:hover i',
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'default' => '',
                'selectors' => [
                    '{{WRAPPER}} .blog-item .blog-content .blog-btn.icon-after:hover i' => 'background: {{VALUE}};',
                ],
            ]
        );
    ...
    protected function render() {
        ...
        $title_postition = $settings['blog_title_show_position'];
        ...
        ?>
            <div class="rsaddon-unique-slider rs-blog-grid blog-grid <?php echo esc_attr($title_postition);?> <?php echo esc_html($settings['align']);?>">
                <div id="rsaddon-slick-slider-<?php echo esc_attr($unique); ?>" class="rs-addon-slider" >
                    <?php 
                        ...
                        <div class="blog-item <?php echo esc_html($settings['blog_content_postion_style']);?> hover-btn-<?php echo esc_html($settings['blog_readmore_show_hover']);?>">
                            <div class="blog-inner-wrap ">
                                <div class="image-wrap">
                                    <?php if(($settings['blog_image_show_hide'] == 'yes') ){ ?>
                                    ...
                                    <?php if(($settings['blog_meta_show_hide'] == 'yes') ){ ?>
                                        ...
                                        <?php if(($settings['date_style'] == 'style2') ){ ?>
                                        
                                        <div class="date date_style2">
                                            <span class="blog_day"><?php echo esc_html($blog_day); ?></span>
                                            <span class="blog_month"><?php echo esc_html($blog_month); ?></span>
                                        </div>
                                        <?php } else{ ?>
                                            <div class="date">
                                            <?php if(($settings['blog_meta_icon_hide'] == 'yes') ){ ?>
                                            <i class="fi fi-rr-time-add" aria-hidden="true"></i>
                                ...
                                <?php } elseif (($settings['blog_content_postion_style'] == 'blog_style_3')) { ?>
                                    <div class="blog-content">
                                        ...
                                        <div class="blog-footer d-flex align-items-center justify-content-center">
                                            ...
                                            <?php if(($settings['blog_cat_show_hide'] == 'yes') ){ ?>
                                                <?php if( "bottom" == $settings['blog_cat_postion_style'] ){ ?>
                                                    <div class="cat_list">
                                                        <?php the_category( ); ?>
                                                    </div>
                                                <?php } ?>
                                ...
                                <?php } elseif (($settings['blog_content_postion_style'] == 'blog_style_4')) { ?>
                                   <div class="blog-content btm-rs blog-style4">

                                    <?php if(($settings['meta_postion_style'] == 'top') ){ ?>

                                        <div class="blog-footer d-flex align-items-center justify-content-between">
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                     
                                            <?php if(!empty($blog_date) || !empty($post_admin)){ ?>
                                                <ul class="blog-meta sep-<?php echo esc_html($settings['blog_separator_show_hide']);?>">
                                                    ...
                                                    <li class="date">
                                                        ...
                                                        <?php } ?>
                                                    <?php echo esc_html($blog_date);?></li>
                                                    <?php } ?>
                                                    ...
                                                    <?php if(($settings['blog_avatar_show_hide'] == 'yes') ){ ?>
                                                        <?php if(!empty($post_admin)){ ?>
                                                            <li class="admin">
                                                                ...
                                                                <?php } ?>
                                                                <?php echo esc_html($post_admin);?></li>
                                                        <?php } ?>
                                                    <?php } ?> 
                                                    
                                                    <?php if(($settings['blog_cat_show_hide'] == 'yes') ){ ?>
                                                        <?php if( "top" != $settings['blog_cat_postion_style'] ){ ?>
                                                            <li class="cat_list btm"> 
                                                                <?php if(($settings['blog_meta_icon_hide'] == 'yes') ){ ?>
                                    ...
                                    <?php } ?>
                                        ...
                                        <?php if(($settings['meta_postion_style'] == 'bottom') ){ ?>
                                    ...
                                    <?php } ?>
                                        ...
                                        <?php if(($settings['blog_readmore_show_hide'] == 'yes') ){ ?>
                                            <?php if(!empty($settings['blog_btn_text'])){ ?>
                                                <div class="blog-btn-part <?php echo esc_html($settings['blog_btn_border']);?>">
                                                    <?php  
                                                        $icon_position = $settings['blog_btn_icon_position'] == 'before' ? 'icon-before' : 'icon-after';
                                                    ?>
                                                        <a class="blog-btn <?php echo esc_attr($icon_position) ?>" href="<?php the_permalink(); ?>">
                                        ...
                                        <div class="blog-footer d-flex align-items-center justify-content-between">
                                            <?php if(!empty($blog_date) || !empty($post_admin)){ ?>
                                                <ul class="blog-meta sep-<?php echo esc_html($settings['blog_separator_show_hide']);?>">
                                                    ...
                                                    <?php if(($settings['blog_meta_show_hide'] == 'yes') ){ ?>
                                                    <li class="date">
                                                       <?php if(($settings['blog_content_postion_style'] == 'transparent')){ ?>
                                                            <span class="blog_day"><?php echo esc_html($blog_date);?></span>                      
                                                        <?php } ?>
                                                    </li>
                                                    <?php } ?>
                                            ...
                                            <?php }else{ ?>
                                                <div class="blog-btn-part2">
                                                    ...
                                                    <a class="blog-btn2 <?php echo esc_attr($icon_position) ?>" href="<?php the_permalink(); ?>">
                                                        ...
                                                        <?php else: ?>
                                                            <span class="custom-blog-btn">
                                                                <?php esc_html_e('Read More', 'tekhub');?> <i class="glyph-icon flaticon-right-arrow"></i>
                                                            </span>
                                                        <?php endif; ?>
                                                    </a>
                                                </div>
