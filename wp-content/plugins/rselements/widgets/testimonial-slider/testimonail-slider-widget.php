...
class Rsaddon_Pro_Testimonial_Slider_Widget extends \Elementor\Widget_Base {
    ...
    protected function register_controls() {
        ...
        $this->add_control(
            'show_hover_img',
            [
                'label'        => esc_html__( 'Show Hover Image', 'rsaddon' ),
        ...
        $this->add_control(
            ...
            [
                'label' => esc_html__( 'Choose Image (Hover)', 'rsaddon' ),
                'type'  => Controls_Manager::MEDIA,             
        ...
        $this->add_control(
            ...
            [
                ...
                'options' => [
                    ...
                    '8000' => esc_html__( '8 Seconds', 'rsaddon' ), 
                    '10000' => esc_html__( '10 Seconds', 'rsaddon' ), 
                ],
                'separator' => 'before',
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'size_units' => [ 'px', 'em', '%' ],
                'selectors' => [
                    '{{WRAPPER}} .testimonial-contents .image-wrap, {{WRAPPER}} .testimonial-content .image-wrap' => 'margin: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                ],
            ]
        );
        ...
        $this->add_control(
            'image_border_color2',
            [
                'label' => esc_html__( 'Image Border Color', 'rsaddon' ),
                'type' => Controls_Manager::COLOR,
                'selectors' => [
                    '{{WRAPPER}} .rs-testimonial-nav-style2 .item img' => 'border-color: {{VALUE}};',             
                    '{{WRAPPER}} .rs-testimonial-nav-style2 .circular .inner' => 'background: {{VALUE}};', 
                ],                
            ]
        );
        ...
        $this->add_control(
            ...
            [
                'label' => esc_html__( 'Animation Border Color', 'rsaddon' ),
                'type' => Controls_Manager::COLOR,
                'selectors' => [
                    '{{WRAPPER}} .rs-testimonial-nav-style2 .circle .bar .progress' => 'background: {{VALUE}};', 
                ],                
            ]
        );
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'size_units' => [ 'px', 'em', '%' ],
                'selectors' => [
                    '{{WRAPPER}} .rs-testimonial-grid' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                ],
                'condition' => [
                    'testimonial_style' => 'style2'
                ]
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'size_units' => [ 'px', '%' ],
                'selectors' => [
                    '{{WRAPPER}} .rs-testimonial, {{WRAPPER}} .rs-testimonial-dots-style2 .slick-slide.slick-center:before, {{WRAPPER}} .rs-testimonial .testimonial-item' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                ],
            ]
        );
        ...
        $this->add_group_control(
            \Elementor\Group_Control_Background::get_type(),
            [
                'name' => 'background_style2',
                'label' => __( 'Background', 'plugin-domain' ),
                'types' => [ 'classic', 'gradient', 'video' ],
                'selector' => '{{WRAPPER}} .rs-testimonial',
                'condition' => [
                    'testimonial_style' => 'style2'
                ]
            ]
        ...
        $this->add_group_control(
            Group_Control_Box_Shadow::get_type(),
            [
                'name' => 'testimonial_boxes_hover_shadow',
                'selector' => '{{WRAPPER}} .rs-testimonial-dots-style2 .slick-slide.slick-center:hover:before, {{WRAPPER}} .rs-testimonial .testimonial-item:hover',
            ]
        );

        $this->end_controls_section();

        // Nav And Dot Style Start
        $this->start_controls_section(
            'section_arrow_bullet_style',
            [
                'label' => esc_html__( 'Slider Controller Style', 'rsaddon' ),
                'tab' => Controls_Manager::TAB_STYLE,
            ]
        );
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'selectors' => [
                    '{{WRAPPER}} .rs-addon-slider .slick-prev, {{WRAPPER}} .rs-testimonial .rs-testimonial-dots-style2 .slick-prev, {{WRAPPER}} .rs-testimonial .rs-addon-slider .slick-prev' => 'top: {{SIZE}}{{UNIT}};',
                ],
                'separator' => 'before',
            ]
        );  
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'selectors' => [
                    '{{WRAPPER}} .rs-addon-slider .slick-prev, {{WRAPPER}} .rs-testimonial .rs-testimonial-dots-style2 .slick-prev, {{WRAPPER}} .rs-testimonial .rs-addon-slider .slick-prev' => 'left: {{SIZE}}{{UNIT}};',
                ],
                'separator' => 'before',
            ]
        );  
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'selectors' => [
                    '{{WRAPPER}} .rs-addon-slider .slick-next, {{WRAPPER}} .rs-testimonial .rs-testimonial-dots-style2 .slick-next, {{WRAPPER}} .rs-testimonial .rs-addon-slider .slick-next' => 'top: {{SIZE}}{{UNIT}};',
                ],
                'separator' => 'before',
            ]
        );
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'selectors' => [
                    '{{WRAPPER}} .rs-addon-slider .slick-next, {{WRAPPER}} .rs-testimonial .rs-testimonial-dots-style2 .slick-next, {{WRAPPER}} .rs-testimonial .rs-addon-slider .slick-next' => 'right: {{SIZE}}{{UNIT}};',
                ],
                'separator' => 'before',
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'options' => [
                    ...
                    'center_align' => [
                        'title' => esc_html__( 'Top & Right Center', 'rsaddon' ),
                        'icon' => 'eicon-menu-bar',
                    ],
                   
                ],
                'selectors' => [
                    '{{WRAPPER}} .rs-testimonial .rs-addon-slider .slick-dots' => 'text-align: {{VALUE}}'
                ],
            ]
        );
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'size_units' => [ 'px', '%' ],
                'selectors' => [
                    '{{WRAPPER}} .rs-testimonial .rs-addon-slider .slick-dots' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                ],
            ]
        );
    ...
    protected function render() {
        ...
        ?>  
            <div class="rsaddon-unique-slider rs-testimonial-grid rs-testimonial rs_nav_dost rs_dots_<?php echo esc_attr( $settings['align_dots'] );?>">
                                ...
                                <div class="item-content <?php echo esc_attr($settings['_design']);?>">
                                    ...
                                    <?php if(!empty($settings['selected_image'])) :?>
                                        <span>
                                            ...
                                            <?php if(!empty($settings['selected_image_hover'])) {?>
                                                <img src="<?php echo esc_url( $settings['selected_image_hover']['url'] );?>" class="hover__img" alt="image"/>
                                            <?php } ?>
                                        </span>
                                    <?php endif;
