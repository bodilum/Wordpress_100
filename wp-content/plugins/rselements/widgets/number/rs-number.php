...
class Rsaddon_Elementor_pro_RSnumber_Grid_Widget extends \Elementor\Widget_Base {
	 ...
	 */
		...
		$this->add_group_control(
		    ...
		    [
		        ...
		        'selector' => '{{WRAPPER}} .rs-addon-number .number-image',
		    ]
		); 
		$this->add_responsive_control(
		    ...
		    [
		        ...
		        'selectors' => [
		            '{{WRAPPER}} .rs-addon-number .number-image img' => 'width: {{SIZE}}{{UNIT}};',
		        ],
		        'separator' => 'before',
		    ]
		);
        ...
        $this->add_responsive_control(
		    ...
		    [
		        ...
		        'size_units' => [ 'px', 'em', '%' ],
		        'selectors' => [
		            '{{WRAPPER}} .rs-addon-number .number-image' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
		        ],
		    ]
		);
	...
	protected function render() {
		...
		<div class="rs-addon-number number al--<?php echo esc_html($settings['align']);?>">
		    <div class="number-part">
		    	<?php if ( !empty( $settings['selected_image']['url'] ) ) { ?>
		    		<div class="number-image"><img src="<?php echo esc_url( $settings['selected_image']['url'] );?>" alt=""></div>
		    	<?php } ?>    		       
