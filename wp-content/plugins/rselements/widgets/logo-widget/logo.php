    ...
    protected function register_controls() {
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'size_units' => ['px', '%'],
                'selectors' => [
                    '{{WRAPPER}} .rs-logo-grid .logo-grid-item img, {{WRAPPER}} .rs-grid-figure' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',           
                ],               
            ]
        );     
        ...
        $this->add_control(
            'grid_border_color_item',
            [
                'label' => esc_html__( 'Border Color', 'rsaddon' ),
                'type' => Controls_Manager::COLOR,
                'selectors' => [
                    '{{WRAPPER}} .rs-logo-grid .logo-grid-item' => 'border-color: {{VALUE}};',
                ],
                'condition' => [
                    'layout' => 'grid'
                ],
            ...
            <div class="rs-logo-grid logo-grid-<?php echo esc_attr($settings['logo_grid_style']); ?> rsl_<?php echo esc_attr( $settings['rs_logo_style'] ); ?>">
                ...
                <?php
                    ...
                    foreach ( $settings['logo_list'] as $index => $item ) :
                        ...
                        ?>
                        <div class="col-lg-<?php echo esc_attr($settings['columns']);?> col-md-3 col-sm-4 col-6 logo-grid-item <?php echo esc_attr( $gap );?> <?php echo esc_attr( $last );?> <?php echo esc_attr( $last_row );?>">
                            <div  class="rs-grid-figure">
                                <div class="logo-img">
                                    ...
                                    <?php } else { ?>
                                        <a><img class="rs-grid-img <?php echo esc_attr( $animation ); ?>" <?php echo esc_attr( $show_tooltip );?> src="<?php echo esc_url( $image ); ?>" title="<?php echo esc_attr( $item['name'] ); ?>" alt="<?php echo esc_attr( $item['name'] ); ?>"></a>
                                    <?php } ?>
                        ...
                        <div class="col-lg-<?php echo esc_attr($settings['columns']);?> col-sm-4 col-6 <?php echo esc_attr( $gap );?> cols grid-item">
                            <div  class="rs-grid-figure">
                                <div class="logo-img">
                                    ...
                                    <?php } else { ?>
                                        <a><img class="hovers-logos rs-grid-img <?php echo esc_attr( $animation ); ?>" <?php echo esc_attr( $show_tooltip );?> src="<?php echo esc_url( $image2 ); ?>" title="<?php echo esc_attr( $item['name'] ); ?>" alt="<?php echo esc_attr( $item['name'] ); ?>">
                                            <img class="mains-logos rs-grid-img <?php echo esc_attr( $animation ); ?>" <?php echo esc_attr( $show_tooltip );?> src="<?php echo esc_url( $image ); ?>" title="<?php echo esc_attr( $item['name'] ); ?>" alt="<?php echo esc_attr( $item['name'] ); ?>"></a>
                                    <?php } ?>
                                </div>
                            </div>
                            ...
                            <div class="grid-item <?php echo esc_attr( $gap );?>">
                                <div  class="rs-grid-figure">
                                    <div class="logo-img ddddd">
                                        ...
                                        <?php } else { ?>
                                            <a>
                                            <img class="hovers-logos rs-grid-img <?php echo esc_attr( $animation ); ?>" <?php echo esc_attr( $show_tooltip );?> src="<?php echo esc_url( $image ); ?>" title="<?php echo esc_attr( $item['name'] ); ?>" alt="<?php echo esc_attr( $item['name'] ); ?>">
                                                <img class="mains-logos rs-grid-img <?php echo esc_attr( $animation ); ?>" <?php echo esc_attr( $show_tooltip );?> src="<?php echo esc_url( $image ); ?>" title="<?php echo esc_attr( $item['name'] ); ?>" alt="<?php echo esc_attr( $item['name'] ); ?>"></a>
                                        <?php } ?>
                                    </div>
                                    <?php if(!empty($item['name'])):?>
