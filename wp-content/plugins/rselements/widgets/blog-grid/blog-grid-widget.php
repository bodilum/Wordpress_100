	...
	protected function register_controls() {		
		...
		$this->add_control(
            ...
            [
                ...
                'options' => [
                    ...
                    'blog_grid_style' => esc_html__( 'Blog Grid', 'rsaddon' ),
                ],                
                'separator' => 'before',
            ]
        );
		...
		$this->add_control(
		    ...
		    [
		        ...
		        'type' => Controls_Manager::COLOR,
		        'selectors' => [
		            '{{WRAPPER}} .blog-item .blog-content .blog-btn:hover, {{WRAPPER}} .blog-item .blog-content .blog-btn:focus ' => 'color: {{VALUE}};',
		        ],
		    ]
		);
			...
			<div class="rs-blog-grid blog-grid">
				<div class="row">
				 	<?php 
						...
						<div class="col-lg-<?php echo esc_html($settings['blog_columns']);?> col-md-<?php echo esc_html($settings['blog_md_columns']);?> col-xs-1"> 
								...
								<div class="blog-inner-wrap ">
									<div class="image-wrap">
										...
										<?php if(($settings['blog_meta_show_hide'] == 'yes') ){ ?>
											...
											<?php if(($settings['blog_content_postion_style'] !== 'blog_grid_style') ){ ?>
									...
									<div class="blog-content">
										...
										<?php if(($settings['blog_content_postion_style'] == 'blog_grid_style') ){ ?>
									  	...
									  	<h3 class="blog-name">
									  		<a class="pointer-events" href="<?php the_permalink();?>"><?php the_title();?></a></h3>
