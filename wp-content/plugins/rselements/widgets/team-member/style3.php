	...
	<div class="row">
		 	<?php //******************//
				...
				while($best_wp->have_posts()): $best_wp->the_post();					
					...
					if($facebook!=''){
						$fb='<li class="facebook"><a href="'.$facebook.'" class="social-icon"><i class="fab fa-facebook-f"></i></a></li>';
					}
					if($twitter!=''){
						$tw='<li class="twitter"><a href="'.$twitter.'" class="social-icon"><i class="fab fa-twitter"></i></a></li>';
					}
					if($google_plus!=''){
						$gp='<li class="google"><a href="'.$google_plus.'" class="social-icon"><i class="fab fa-instagram"></i></a></li>';
					}
					if($linkedin!=''){
						$ldin='<li class="linkedin"><a href="'.$linkedin.'" class="social-icon"><i class="fab fa-linkedin-in"></i></a></li>';
					}
				?>
								       	...
								       	<div class="author-text">
								       		<h3 class="team-name">
											    ...
											    <?php endif; ?>
								       		  ...
								       		  <div class="team-title"><?php echo esc_html( $designation );?></div>
								       	</div>	  
								       <?php endif;?>
								...
								<div class="team-content">
									...
									<div class="contact-info">
										<ul>
											...
											<?php if( $show_email ): ?>
												<li <?php echo wp_kses_post($popup_phn_email_color);?>><span><?php echo esc_html('Email:', 'rsaddon');?> </span><a href="mailto:<?php echo esc_html($show_email); ?>"<?php echo wp_kses_post($popup_phn_email_color);?>><?php echo esc_html($show_email); ?></a></li>
											<?php endif; ?>
										</ul>
									</div>
									<?php endif; ?>
