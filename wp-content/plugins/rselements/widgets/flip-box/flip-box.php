        ...
        $this->start_controls_section(
            ...
            $this->add_responsive_control(
                ...
                [
                    ...
                    'selectors' => [
                        '{{WRAPPER}} .back-icon-part .front-img, {{WRAPPER}} .front-part .front-content-part .front-icon-part .front-icon' => 'width: {{SIZE}}{{UNIT}};',
                    ],            
                ]
            );
            ...
            $this->add_responsive_control(
                ...
                [
                    ...
                    'selectors' => [
                        '{{WRAPPER}} .back-icon-part .front-img, {{WRAPPER}} .front-part .front-content-part .front-icon-part .front-icon' => 'height: {{SIZE}}{{UNIT}};',
                    ],             
                ]
            ); 
            ...
            $this->add_responsive_control(
                ...
                [
                    ...
                    'selectors' => [
                        '{{WRAPPER}} .back-icon-part .front-img, {{WRAPPER}} .front-part .front-content-part .front-icon-part .front-icon' => 'line-height: {{SIZE}}{{UNIT}};',
                    ],               
                ]
            );
        ...
        $this->start_controls_section(
            ...
            $this->add_responsive_control(
                ...
                [
                    ...
                    'selectors' => [
                        '{{WRAPPER}} .back-part .back-content-part .back-icon-part .back-img, {{WRAPPER}} .back-part .back-content-part .back-icon-part .back-icon' => 'width: {{SIZE}}{{UNIT}};',
                    ],            
                ]
            );
            ...
            $this->add_responsive_control(
                ...
                [
                    ...
                    'selectors' => [
                        '{{WRAPPER}} .back-part .back-content-part .back-icon-part .back-img, {{WRAPPER}} .back-part .back-content-part .back-icon-part .back-icon' => 'height: {{SIZE}}{{UNIT}};',
                    ],              
                ]
            ); 
            ...
            $this->add_responsive_control(
                ...
                [
                    ...
                    'selectors' => [
                        '{{WRAPPER}} .back-part .back-content-part .back-icon-part .back-img, {{WRAPPER}} .back-part .back-content-part .back-icon-part .back-icon' => 'line-height: {{SIZE}}{{UNIT}};',
                    ],              
                ]
            );
