	...
	protected function register_controls() {		
        ...
        $this->add_control(
            ...
            [
                ...
                'type' => Controls_Manager::COLOR,
                'selectors' => [
                    '{{WRAPPER}} .rs-portfolio-style3 .portfolio-item .portfolio-content .portfolio-inner' => 'background: {{VALUE}};',                    
                ],
                'condition' => [
        ...
        $this->add_control(
            ...
            [
                ...
                'type' => Controls_Manager::COLOR,
                'selectors' => [
                    '{{WRAPPER}} .rs-portfolio-style3 .portfolio-item .p-icon i, {{WRAPPER}} .rs-portfolio-style1 .portfolio-item .portfolio-img a, {{WRAPPER}} .rs-portfolio-style7 .content-overlay a, {{WRAPPER}} .rs-portfolio-style2 .portfolio-item .portfolio-content .p-icon a, {{WRAPPER}} .rs-portfolio-style2 .portfolio-content a' => 'color: {{VALUE}};',                    
                ],              
            ]
        ...
        $this->add_control(
            ...
            [
                ...
                'type' => Controls_Manager::COLOR,
                'selectors' => [
                    '{{WRAPPER}} .rs-portfolio-style3 .portfolio-item .p-icon, {{WRAPPER}} .rs-portfolio-style1 .portfolio-item .portfolio-img a, {{WRAPPER}} .rs-portfolio-style2 .portfolio-item .portfolio-content .p-icon, {{WRAPPER}} .rs-portfolio-style7 .content-overlay a.link7' => 'background: {{VALUE}};',                    
                ],              
            ]
        ...
        $this->add_group_control(
			...
			[
				...
				'selector' => '{{WRAPPER}} .rs-portfolio-style1 .portfolio-item .portfolio-img a, {{WRAPPER}} .rs-portfolio-style7 .content-overlay a, {{WRAPPER}} .rs-portfolio-style2 .portfolio-item .portfolio-content .p-icon',                    
			]
		);
		$this->add_responsive_control(
		    'item_padding',
        ...
        $this->add_group_control(
            ...
            [
                ...
                'selector' => '{{WRAPPER}} .portfolio-item, {{WRAPPER}} .rs-portfolio-style2 .portfolio-item:before, {{WRAPPER}} .portfolio-content:before, {{WRAPPER}} .rs-portfolio-style7 .content-overlay:before, {{WRAPPER}} .rs-portfolio-style6 .portfolio-item .portfolio-content:before',
