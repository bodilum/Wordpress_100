...
class Rsaddon_Pro_Advance_Tab_Widget extends \Elementor\Widget_Base {
	...
	protected function register_controls() {
        ...
        $repeater->add_control(
            ...
            [
                'label'       => esc_html__( 'Title Image (Hover)', 'rsaddon' ),
                'type'        => Controls_Manager::MEDIA,
                'label_block' => true,
            ]
        );
        ...
        $repeater->add_control(
            'tab_content_title__color',
            [
                'label' => esc_html__( 'Color', 'rsaddon' ),
                'type' => Controls_Manager::COLOR,
                'selectors' => [
                    '{{WRAPPER}} .content--left-area h2' => 'color: {{VALUE}}',
                ],
                'condition' => [
                    'tab_content_title!' => '',
                ],
        ...
        $repeater->add_group_control(
            ...
            [
                ...
                'selector' => '{{WRAPPER}}  .content--left-area h2',
                'separator'   => 'before',
                'condition' => [
                    'tab_content_title!' => '',
                ],
        ...
        $repeater->add_control(
            ...
            [
                ...
                'type'        => Controls_Manager::TEXT,
                'placeholder' => esc_html__( 'Button Link', 'rsaddon' ),
                'label_block' => true,
            ]
        );

        $repeater->add_control(
            'tab_content_btn__color_bg',
            [
                'label' => esc_html__( 'Background Color', 'rsaddon' ),
                'type' => Controls_Manager::COLOR,
                'selectors' => [
                    '{{WRAPPER}} .content--teb-area .content--left-area .rs-btn a' => 'background-color: {{VALUE}}',
                ],
                'condition' => [
                    'tab_content_btn!' => '',
                ],
        ...
        $repeater->add_control(
            'tab_content_btn__color',
            [
                'label' => esc_html__( 'Color', 'rsaddon' ),
                'type' => Controls_Manager::COLOR,
                'selectors' => [
                    '{{WRAPPER}} .content--teb-area .content--left-area .rs-btn a' => 'color: {{VALUE}}',
                ],
                'condition' => [
                    'tab_content_btn!' => '',
                ],
        ...
        $repeater->add_control(
            'tab_content_btn__color_bg_hovber',
            [
                'label' => esc_html__( 'Background Color (Hover)', 'rsaddon' ),
                'type' => Controls_Manager::COLOR,
                'selectors' => [
                    '{{WRAPPER}} .content--teb-area .content--left-area .rs-btn a:hover' => 'background-color: {{VALUE}}',
                ],
                'condition' => [
                    'tab_content_btn!' => '',
                ],
        ...
        $repeater->add_control(
            'tab_content_btn__color_hover',
            [
                'label' => esc_html__( 'Color (Hover)', 'rsaddon' ),
                'type' => Controls_Manager::COLOR,
                'selectors' => [
                    '{{WRAPPER}} .content--teb-area .content--left-area .rs-btn a:hover' => 'color: {{VALUE}}',
                ],
                'condition' => [
                    'tab_content_btn!' => '',
                ],
        ...
        $repeater->add_group_control(
            Group_Control_Typography::get_type(),
            [
                'name' => 'tab_content_btn_typography',
                'label' => esc_html__( 'Typography', 'rsaddon' ),
                'selector' => '{{WRAPPER}}  .content--teb-area .content--left-area .rs-btn a',
                'separator'   => 'before',
                'condition' => [
                    'tab_content_btn!' => '',
                ],
        ...
        //start content styling
         ...
         $this->add_control(
            ...
            [
                ...
                'type' => Controls_Manager::COLOR,
                'selectors' => [
                    '{{WRAPPER}} .rstab-main .tab-content .title' => 'color: {{VALUE}};',
                ],               
            ]
        );
        ...
        $this->add_group_control(
            ...
            [
                ...
                'selector' => '{{WRAPPER}} .rstab-main .tab-content .title',                
                'separator' => 'before',
            ]
        );
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'size_units' => [ 'px', 'em', '%' ],
                'selectors' => [
                    '{{WRAPPER}} .rstab-main .tab-content .title' => 'margin: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                ],
            ]
        );
        ...
        <div class="rstab-main <?php echo esc_attr($settings['type']); ?> <?php echo esc_attr($settings['tabs_item_width']); ?>"> 
            <ul  class="nav nav-nav-tabs <?php echo esc_attr($settings['tab_design']);?> <?php echo esc_attr($settings['tab_icon_position']);?>">
                ...
                foreach ( $tabs as $index => $item ) :
                    ...
                    $titleimg    = !empty($item['selected_image']) ? '<img class="nor_img" src="'. $item['selected_image']['url']. '" alt="icon-image" />' : '';
                    $titleimg2    = !empty($item['selected_image_hover']) ? '<img class="hob_img" src="'. $item['selected_image_hover']['url']. '" alt="icon-image"/>' : '';
                    ...
                    <li class="nav-item"><a class="nav-link <?php echo esc_attr($active_tab); ?>" data-toggle="tab" href="#a<?php echo esc_html($x);?><?php echo esc_html( $unique );?>">
                        <?php if(!empty($icon) || $titleimg || $titleimg2){
                                ...
                                <div class="content--teb-area <?php echo esc_attr($fulls); ?>">
                                    ...
                                    <div class="content--left-area">
                                        ...
                                        <?php if(!empty($item['tab_content_btn'])){?>
                                            <div class="rs-btn">
                                                <a href="<?php echo esc_url( $item['tab_content_btn_link'] ); ?>" class="rs_button"><?php echo $this->parse_text_editor( $item['tab_content_btn'] ); ?></a>
                                            </div>
                                        <?php } ?>
                                    </div>
