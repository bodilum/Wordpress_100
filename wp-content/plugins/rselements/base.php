...
final class Rsaddon_Elementor_Pro_Extension {
	...
	public function init_widgets() {
		...
		require_once( __DIR__ . '/widgets/rs_slider/slider-widget.php' );		
		...
		require_once( __DIR__ . '/widgets/rs-pricing-table/rs-pricing-table.php');
		...
		require_once( __DIR__ . '/widgets/testimonial-slider-custom/testimonail-widget.php' );
		...
		require_once( __DIR__ . '/widgets/hover-tabs/hover-tabs.php' );
		...
		\Elementor\Plugin::instance()->widgets_manager->register_widget_type( new \Rsaddon_Slider_Pro_Widget() );
		...
		\Elementor\Plugin::instance()->widgets_manager->register_widget_type( new \Rsaddon_Elementor_pro_RSservices_Slider_Widget() );		
		...
		\Elementor\Plugin::instance()->widgets_manager->register_widget_type( new \Rsaddon_Elementor_pro_Pricing_RS_Table_Widget() );		
		...
		\Elementor\Plugin::instance()->widgets_manager->register_widget_type( new \Rsaddon_Pro_Testimonial_custom_Slider_Widget() );		
		...
		\Elementor\Plugin::instance()->widgets_manager->register_widget_type( new \Rsaddon_Elementor_pro_Breadcrumb_Widget() );	
		\Elementor\Plugin::instance()->widgets_manager->register_widget_type( new \Widget_Rs_Accordion() );			
		\Elementor\Plugin::instance()->widgets_manager->register_widget_type( new \Rsaddon_Elementor_pro_RSNewsLetter_Widget() );		
		\Elementor\Plugin::instance()->widgets_manager->register_widget_type( new \Rsaddon_Elementor_Pro_HoverTabs_Widget() );	
