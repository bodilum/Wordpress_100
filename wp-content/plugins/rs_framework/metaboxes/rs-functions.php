...
function rs_register_header_metabox() {
  ...
  /**
		...
		'tabs' => array(
            ...
            array(
                ...
                'fields' => array(
                    ...
                    'sticky_hamburgers_bg_color',
                    'sticky_hamburgers_icons_color'
                ),
            ),
            array(
                'id'    => 'tab-7',
	...
	$cmb_demo->add_field( array(
		'name'    => esc_html__( 'Search Icon Sticky Color', 'cmb2' ),
		'desc'    => esc_html__( 'Choose Search  Icon Sticky color', 'cmb2' ),
		'id'      => 'search_icon_sticky_color',
		'type'    => 'colorpicker',
		'default' => '',		
	) );
	...
	// Humburger
	$cmb_demo->add_field( array(
		'name'    => esc_html__( 'Hamburger Background Color', 'cmb2' ),
		'desc'    => esc_html__( 'Choose Hamburger Background color', 'cmb2' ),
	...
	$cmb_demo->add_field( array(
		'name'    => esc_html__( 'Hamburger Icon Color', 'cmb2' ),
		'desc'    => esc_html__( 'Choose icon color', 'cmb2' ),
	...
	$cmb_demo->add_field( array(
		'name'    => esc_html__( 'Sticky Hamburger Background Color', 'cmb2' ),
		'desc'    => esc_html__( 'Choose Sticky Hamburger Dots color', 'cmb2' ),
		'id'      => 'sticky_hamburgers_bg_color',
		'type'    => 'colorpicker',
		'default' => '',		
	) );

	$cmb_demo->add_field( array(
		'name'    => esc_html__( 'Sticky Hamburger Icon Color', 'cmb2' ),
		'desc'    => esc_html__( 'Choose Sticky Hamburger Dots color', 'cmb2' ),
		'id'      => 'sticky_hamburgers_icons_color',
		'type'    => 'colorpicker',
		'default' => '',		
	) );
	...
	$cmb_demo->add_field( array(
		...
		'desc'    => esc_html__( 'example(70px)', 'rs-framework' ),
	...
	$cmb_demo->add_field( array(
		'name'    => esc_html__( 'Footer input Button Color', 'cmb2' ),
		'desc'    => esc_html__( 'Footer input Button Color', 'cmb2' ),
		'id'      => 'footer_in_btn_color',
		'type'    => 'colorpicker',
		'default' => '',		
	) );
	...
	$cmb_demo->add_field( array(
		'name'    => esc_html__( 'ScrollUp Icon Color', 'cmb2' ),
		'desc'    => esc_html__( 'select border color', 'cmb2' ),
		'id'      => 'scrollUp_icon',
		'type'    => 'colorpicker',
		'default' => '',
