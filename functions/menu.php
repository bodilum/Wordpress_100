...
register_nav_menus(
	array(
		'main-nav'		=> __( 'The Main Menu', 'siana_v1' ),		// Main nav in header
		'offcanvas-nav'	=> __( 'The Off-Canvas Menu', 'siana_v1' ),	// Off-Canvas nav
		'footer-links'	=> __( 'Footer Links', 'siana_v1' )			// Secondary nav in footer 
	)
);
